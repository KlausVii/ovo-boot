...
class FxFigureCanvas(app: JFXApp, width: Int = 800, height: Int = 600)
  ...
  def fillRectangle(x: Double, y: Double, w: Double, h: Double): Unit = {
    val node = getNodeForFilledRectangle(x,
                                         y,
                                         w,
                                         h,
                                         Color.rgb(color.getRed,
                                                   color.getGreen,
                                                   color.getBlue,
  ...
  def outlineRectangle(x: Double, y: Double, w: Double, h: Double): Unit = {
    val node = getNodeForRectangleOutline(x,
                                          y,
                                          w,
                                          h,
                                          Color.rgb(color.getRed,
  ...
  def fillEllipse(x: Double, y: Double, hr: Double, vr: Double): Unit = {
    val node = getNodeForFilledEllipse(x,
                                       y,
                                       hr,
                                       vr,
                                       Color.rgb(color.getRed,
  ...
  def outlineEllipse(x: Double, y: Double, hr: Double, vr: Double): Unit = {
    val node = getNodeForEllipseOutline(x,
                                        y,
                                        hr,
                                        vr,
                                        Color.rgb(color.getRed,
  ...
  def getNodeForFilledRectangle(x: Double,
                                y: Double,
                                w: Double,
                                h: Double,
                                fill: Color): Node = {
  ...
  def getNodeForRectangleOutline(x: Double,
                                 y: Double,
                                 w: Double,
                                 h: Double,
                                 stroke: Color): Node = {
  ...
  def getNodeForFilledEllipse(x: Double,
                              y: Double,
                              hr: Double,
                              vr: Double,
                              fill: Color): Node = {
  ...
  def getNodeForEllipseOutline(x: Double,
                               y: Double,
                               hr: Double,
                               vr: Double,
                               stroke: Color): Node = {
  ...
  def clearAndDrawAll(nodes: Node*): Unit =
    Platform.runLater(() => {
      drawingPane.children = nodes
    })

  def draw(node: Node): Unit = drawingPane.children.add(node)

  def drawAll(nodes: Node*): Unit =
    Platform.runLater(() => {
  ...
  def eraseAll(nodes: Node*): Unit =
    Platform.runLater(() => {
      ...
      println(nodes.foldLeft(true)((x: Boolean, y: Node) =>
        x & drawingPane.children.remove(y)))
    })
}
